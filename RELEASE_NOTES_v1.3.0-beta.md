...
- **Self Hosted Characters:** Add characters on self-hosted worlds with the same freeform world/server-name flow used by private servers.
- **Blueprints Navigation:** Added a Blueprints tab to desktop and mobile navigation.
...
| Platform | File |
|----------|------|
| Linux x64 | `dune-awakening-companion-v1.3.0-beta-linux-x64.tar.gz` |
| Windows x64 | `dune-awakening-companion-v1.3.0-beta-windows-x64.zip` |
| macOS | `dune-awakening-companion-v1.3.0-beta-macos.zip` |
| Android | `dune-awakening-companion-v1.3.0-beta-android.apk` |
