...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get characterClosedWorldBadge => 'Світ закрито';

  @override
  String get characterClosedWorldTooltip =>
      'Цей світ закрито під час міграції серверів 26 травня 2026 року. Перемістіть свого персонажа на інший світ у грі — це лише нагадування.';
  ...
  @override
  String get characterWorldCustomOption => 'Інший / власний світ…';

  @override
  String get characterWorldCustomLabel => 'Власний світ';

  @override
  String get characterWorldCustomHint => 'Введіть будь-яку назву світу';
  ...
  @override
  String get baseCalculatorCategoryRefineries => 'Переробка';

  @override
  String get baseCalculatorCategoryStorage => 'Сховище';

  @override
  String get baseCalculatorNoPowerDraw => 'Без споживання енергії';

  @override
  String get baseCalculatorStorageTitle => 'Перевезення та поїздки';

  @override
  String get baseCalculatorHaulingOptional =>
      'Необов\'язково — оцінка кількості поїздок';
  ...
  String get baseCalculatorConfigureStorage =>
      'Додайте контейнер нижче, щоб оцінити поїздки.';
